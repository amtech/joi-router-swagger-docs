...
exports.validateToSwaggerParameters = function(validate, definitions) {
  ...
  if (validate.body) {
    console.log('body: ');
    //put a reference in, if this exists
    // let joiSchema = validate.body;
    // joiSchema = joiSchema.meta({ className: 'church' });
    // let j2sObject = j2s(joiSchema, definitions);
    // let swaggerSchema = j2sObject.swagger;
    // console.log(j2sObject);
